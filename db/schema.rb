...
ActiveRecord::Schema.define(version: 2020_10_23_005216) do
  ...
  create_table "doc_specialties", force: :cascade do |t|
    t.integer "doctor_id"
    t.integer "specialty_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["doctor_id"], name: "index_doc_specialties_on_doctor_id"
    t.index ["specialty_id"], name: "index_doc_specialties_on_specialty_id"
  end
  ...
  add_foreign_key "cities", "appointments"
